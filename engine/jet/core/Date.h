...
static const char* const tzLabels_[] = { "-1200", "-1130", "-1100", "-1030",
  ...
  "-0200", "-0130", "-0100", "-0030", "", "+0030", "+0100", "+0130",
...
Date Date_add(Date base, Duration diff) {
  ...
  // TODO: correction for leap days: go over all leap days starting from
  // 29/2 in orig.year and check if it falls within the interval [ orig ...
  // new ]. if so add a day (check overflow, also for months if > 30 days
  // added...)
