...
// this is also a sparse ND-tensor impleentation if you set the key type as
// Int and value type as double etc.
...
// When you know the hash bounds, use this function to init. This is the
// case when you are creating a sparse matrix with known shape and the hash
