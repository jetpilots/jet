 local tk = {
    ...
    ArgAssign = {id=72, name="ArgAssign", repr="a="}, 
    ...
    Assign = {id=109, name="Assign", repr=" = "}, 
    PlusEq = {id=110, name="PlusEq", repr=" += "}, 
    MinusEq = {id=111, name="MinusEq", repr=" -= "}, 
    SlashEq = {id=112, name="SlashEq", repr=" /= "}, 
    TimesEq = {id=113, name="TimesEq", repr=" *= "}, 
    ColEq = {id=114, name="ColEq", repr=" := "}, 
    ModEq = {id=115, name="ModEq", repr=" %= "}, 
    __tk__selfMutOps__end = {id=116, name="__tk__selfMutOps__end", repr=""}, 
    Question = {id=117, name="Question", repr="?"}, 
    Unknown = {id=118, name="Unknown", repr="(unk)"}, 
}
return tk
