...
start() {
    ...
    echo "typedef enum TokenKind {" >> TokenKinds.h
    echo "static const char* const TokenKinds_repr[] = {" > TokenKinds_repr.h
    echo "static const char* const TokenKinds_srepr[] = {" > TokenKinds_srepr.h
    echo "static const char* const TokenKinds_names[] = {" > TokenKind_names.h
}
...
finish() {
    ...
    echo "} TokenKind;\n" >> TokenKinds.h
    echo '#include "TokenKinds_repr.h"' >> TokenKinds.h
    echo '#include "TokenKinds_srepr.h"' >> TokenKinds.h
    echo '#include "TokenKind_names.h"' >> TokenKinds.h
    # cat TokenKinds.h TokenKind_names.h TokenKinds_repr.h TokenKinds_srepr.h > TokenKindDefs.h
    # rm TokenKinds.h TokenKind_names.h TokenKinds_repr.h TokenKinds_srepr.h
}
...
add() {
    ...
    if [ -n "$srepr" ]; then
        ...
        echo "    [$1] = \"$srepr\"," >> TokenKinds_srepr.h
        echo "    [$1] = \"$repr\"," >> TokenKinds_repr.h
    fi
}
