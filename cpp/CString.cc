...
public:
    ...
    CString pclone(const CString str) { return pndup(str, strlen(str)); }
    ...
    CString clone(const CString str) { return ndup(str, strlen(str)); }

    size_t length(CString str) { return strlen(str); }
